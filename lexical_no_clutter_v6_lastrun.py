...
for thisBlock in blocks:
    ...
    # keep track of which components have finished
    get_trialsComponents = [background_panel_3, key_resp, instruction_image]
    ...
    for thisTrial in trials:
        ...
        # keep track of which components have finished
        screen_display_imagesComponents = [background_panel, panel1, panel2, panel3, panel4, panel5, panel6, lexical_text, lexical_response, sound_cue]
        ...
        while continueRoutine:
            ...
            if lexical_text.status == NOT_STARTED and tThisFlip >= stim_offset-frameTolerance:
                # keep track of start time/frame for later
...
_finish_key_allKeys = []
# keep track of which components have finished
finish_instructionsComponents = [background_panel_4, finish_text, finish_key]
