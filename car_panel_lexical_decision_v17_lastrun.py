...
for thisTrial in trials:
    ...
    widget3_text1.setText(all_widgets[3]["image_components"]["temperature"]["file"])
    ...
    widget5_text1.setPos([correctTextPosition(widget5_text1, all_widgets[3]["text_components"]["date"]["position_pixel"])])
    widget5_text1.setOri(0.0)
    widget5_text1.setText(all_widgets[1]["image_components"]["date"]["file"])
